...
public abstract class AbstractNiceDialog extends JDialog {
	...
	protected static final ApplicationContext ctx = AppContext.getApplicationContext();
	protected static final ResourceService resources = (ResourceService)ctx.getBean(BeanDirectory.SERVICE_RESOURCE);
	protected static final ApplicationWindow win = (ApplicationWindow) ctx.getBean(BeanDirectory.WINDOW_APPLICATION);
