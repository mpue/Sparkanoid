...
public class CmdJMenuItem extends JMenuItem implements CommandHolder {
	...
	public CmdJMenuItem(String name, Icon icon,JFrame frm) {
		super(name,icon);
		frame = frm;
		this.addActionListener(new CmdActionListener());
	}
	
	public CmdJMenuItem(String name, Icon icon,Command command, String mnemonic,String tooltipText,JFrame frm) {
		super(name,icon);
		this.frame = frm;
