...
public class StringUtil {
	 ...
	 * the function steps back inside the character array as long as a
	 * whitespace is found.
	 * </p>
	 * <p>
	 ...
	 * @param lineWidth    the with of the line (the expected position of the linebreak)
	 * @param html         force html output
	 * 
	 * @return             the converted String containing line breaks
	 */
	public static String createLineBreaks(String originalText, int lineWidth, boolean html) {
